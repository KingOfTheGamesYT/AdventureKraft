...
public class PointOfInterestType extends net.minecraftforge.registries.ForgeRegistryEntry<PointOfInterestType> {
   ...
   public PointOfInterestType(String nameIn, Set<BlockState> blockStatesIn, int maxFreeTicketsIn, Predicate<PointOfInterestType> predicateIn, int validRangeIn) {
      this.name = nameIn;
      this.blockStates = ImmutableSet.copyOf(blockStatesIn);
      this.maxFreeTickets = maxFreeTicketsIn;
      this.predicate = predicateIn;
      this.validRange = validRangeIn;
   }

   public PointOfInterestType(String nameIn, Set<BlockState> blockStatesIn, int maxFreeTicketsIn, int validRangeIn) {
      this.name = nameIn;
      this.blockStates = ImmutableSet.copyOf(blockStatesIn);
      this.maxFreeTickets = maxFreeTicketsIn;
   ...
   private static PointOfInterestType register(String key, Set<BlockState> blockStatesIn, int maxFreeTicketsIn, int validRangeIn) {
      return registerBlockStates(Registry.POINT_OF_INTEREST_TYPE.register(new ResourceLocation(key), new PointOfInterestType(key, blockStatesIn, maxFreeTicketsIn, validRangeIn)));
   }

   private static PointOfInterestType register(String key, Set<BlockState> blockStatesIn, int maxFreeTicketsIn, Predicate<PointOfInterestType> predicateIn, int validRangeIn) {
      return registerBlockStates(Registry.POINT_OF_INTEREST_TYPE.register(new ResourceLocation(key), new PointOfInterestType(key, blockStatesIn, maxFreeTicketsIn, predicateIn, validRangeIn)));
   }
