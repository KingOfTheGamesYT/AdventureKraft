...
public interface IServerPlayNetHandler extends INetHandler {
   ...
   void processUpdateJigsawBlock(CUpdateJigsawBlockPacket packetIn);

   void processSetDifficulty(CSetDifficultyPacket packetIn);

   void processLockDifficulty(CLockDifficultyPacket packetIn);
}
