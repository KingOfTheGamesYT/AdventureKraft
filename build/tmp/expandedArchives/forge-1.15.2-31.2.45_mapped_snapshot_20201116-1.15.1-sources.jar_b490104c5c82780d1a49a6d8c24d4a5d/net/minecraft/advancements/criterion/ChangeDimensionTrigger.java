...
public class ChangeDimensionTrigger extends AbstractCriterionTrigger<ChangeDimensionTrigger.Instance> {
   ...
   public static class Instance extends CriterionInstance {
      ...
      public static ChangeDimensionTrigger.Instance changedDimensionTo(DimensionType dimensionIn) {
         return new ChangeDimensionTrigger.Instance((DimensionType)null, dimensionIn);
      }
