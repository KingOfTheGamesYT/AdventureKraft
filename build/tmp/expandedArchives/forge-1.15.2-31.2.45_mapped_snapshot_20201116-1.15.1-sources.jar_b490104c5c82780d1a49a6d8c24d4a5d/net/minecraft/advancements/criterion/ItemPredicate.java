...
public class ItemPredicate {
   ...
   public ItemPredicate(@Nullable Tag<Item> tagIn, @Nullable Item itemIn, MinMaxBounds.IntBound countBounds, MinMaxBounds.IntBound p_i225740_4_, EnchantmentPredicate[] p_i225740_5_, EnchantmentPredicate[] p_i225740_6_, @Nullable Potion p_i225740_7_, NBTPredicate nbtIn) {
      this.tag = tagIn;
      this.item = itemIn;
      this.count = countBounds;
