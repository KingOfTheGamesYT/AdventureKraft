...
public class FlowerPotBlock extends Block {
   ...
   public FlowerPotBlock(Block blockIn, Block.Properties properties) {
      this(Blocks.FLOWER_POT == null ? null : () -> (FlowerPotBlock) Blocks.FLOWER_POT.delegate.get(), () -> blockIn.delegate.get(), properties);
      if (Blocks.FLOWER_POT != null) {
         ((FlowerPotBlock)Blocks.FLOWER_POT).addPlant(blockIn.getRegistryName(), () -> this);
      }
   }
    ...
    * @param blockIn The flower block.
    * @param properties
    */
   public FlowerPotBlock(@javax.annotation.Nullable java.util.function.Supplier<FlowerPotBlock> emptyPot, java.util.function.Supplier<? extends Block> blockIn, Block.Properties properties) {
      super(properties);
