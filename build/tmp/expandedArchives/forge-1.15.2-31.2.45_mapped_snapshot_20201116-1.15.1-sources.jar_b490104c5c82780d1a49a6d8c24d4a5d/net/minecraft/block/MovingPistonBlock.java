...
public class MovingPistonBlock extends ContainerBlock {
   ...
   public static TileEntity createTilePiston(BlockState state, Direction directionIn, boolean extendingIn, boolean shouldHeadBeRenderedIn) {
      return new PistonTileEntity(state, directionIn, extendingIn, shouldHeadBeRenderedIn);
   }
