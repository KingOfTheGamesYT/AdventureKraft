...
public class FenceBlock extends FourWayBlock {
   ...
   public boolean canConnect(BlockState state, boolean p_220111_2_, Direction directionIn) {
      Block block = state.getBlock();
      boolean flag = block.isIn(BlockTags.FENCES) && state.getMaterial() == this.material;
      boolean flag1 = block instanceof FenceGateBlock && FenceGateBlock.isParallel(state, directionIn);
