...
public class ScaffoldingBlock extends Block implements IWaterLoggable {
   ...
   private boolean func_220116_a(IBlockReader blockReader, BlockPos pos, int p_220116_3_) {
      return p_220116_3_ > 0 && blockReader.getBlockState(pos.down()).getBlock() != this;
   }
   ...
   static {
      ...
      NORMAL_SHAPE = VoxelShapes.or(voxelshape, voxelshape1, voxelshape2, voxelshape3, voxelshape4);
      ...
      BOTTOM_SHAPE = VoxelShapes.or(field_220123_f, NORMAL_SHAPE, voxelshape6, voxelshape5, voxelshape8, voxelshape7);
   }
}