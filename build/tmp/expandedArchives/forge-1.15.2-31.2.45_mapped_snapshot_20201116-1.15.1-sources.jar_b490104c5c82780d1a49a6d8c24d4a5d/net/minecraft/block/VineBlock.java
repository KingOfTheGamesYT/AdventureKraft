...
public class VineBlock extends Block implements net.minecraftforge.common.IShearable {
   ...
   private boolean func_196541_a(IBlockReader blockReader, BlockPos pos, Direction directionIn) {
      if (directionIn == Direction.DOWN) {
         ...
         if (canAttachTo(blockReader, blockpos, directionIn)) {
            ...
            BooleanProperty booleanproperty = FACING_TO_PROPERTY_MAP.get(directionIn);
   ...
   private boolean func_196539_a(IBlockReader blockReader, BlockPos pos) {
      ...
      for(BlockPos blockpos : iterable) {
         if (blockReader.getBlockState(blockpos).getBlock() == this) {
            --j;
            if (j <= 0) {
               return false;
            }
