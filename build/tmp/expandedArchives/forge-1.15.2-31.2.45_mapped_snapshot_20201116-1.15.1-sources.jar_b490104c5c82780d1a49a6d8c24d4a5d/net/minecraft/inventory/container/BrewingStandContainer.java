...
public class BrewingStandContainer extends Container {
   ...
   public BrewingStandContainer(int id, PlayerInventory playerInventoryIn) {
      this(id, playerInventoryIn, new Inventory(5), new IntArray(2));
   }

   public BrewingStandContainer(int id, PlayerInventory playerInventoryIn, IInventory inventoryIn, IIntArray p_i50096_4_) {
      super(ContainerType.BREWING_STAND, id);
      assertInventorySize(inventoryIn, 5);
      assertIntArraySize(p_i50096_4_, 2);
      this.tileBrewingStand = inventoryIn;
      this.field_216983_d = p_i50096_4_;
      this.addSlot(new BrewingStandContainer.PotionSlot(inventoryIn, 0, 56, 51));
      this.addSlot(new BrewingStandContainer.PotionSlot(inventoryIn, 1, 79, 58));
      this.addSlot(new BrewingStandContainer.PotionSlot(inventoryIn, 2, 102, 51));
      this.slot = this.addSlot(new BrewingStandContainer.IngredientSlot(inventoryIn, 3, 79, 17));
      this.addSlot(new BrewingStandContainer.FuelSlot(inventoryIn, 4, 17, 17));
