...
public class LoomContainer extends Container {
   ...
   public LoomContainer(int id, PlayerInventory playerInventoryIn) {
      this(id, playerInventoryIn, IWorldPosCallable.DUMMY);
   }

   public LoomContainer(int id, PlayerInventory playerInventoryIn, final IWorldPosCallable worldCallable) {
