...
public class RepairContainer extends Container {
   ...
   public RepairContainer(int id, PlayerInventory playerInventoryIn) {
      this(id, playerInventoryIn, IWorldPosCallable.DUMMY);
   }

   public RepairContainer(int id, PlayerInventory playerInventoryIn, final IWorldPosCallable worldPosCallableIn) {
      super(ContainerType.ANVIL, id);
      ...
      this.addSlot(new Slot(this.outputSlot, 2, 134, 47) {
         ...
         public ItemStack onTake(PlayerEntity thePlayer, ItemStack stack) {
            ...
            worldPosCallableIn.consume((p_216931_1_, p_216931_2_) -> {
   ...
   public boolean canInteractWith(PlayerEntity playerIn) {
      return this.worldPosCallable.applyOrElse((p_216979_1_, p_216979_2_) -> {
