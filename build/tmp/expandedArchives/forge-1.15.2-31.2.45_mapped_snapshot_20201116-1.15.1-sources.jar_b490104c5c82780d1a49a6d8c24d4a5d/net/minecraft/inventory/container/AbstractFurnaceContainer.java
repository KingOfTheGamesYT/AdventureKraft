...
public abstract class AbstractFurnaceContainer extends RecipeBookContainer<IInventory> {
   ...
   public void func_217056_a(boolean p_217056_1_, IRecipe<?> p_217056_2_, ServerPlayerEntity playerIn) {
      (new ServerRecipePlacerFurnace<>(this)).place(playerIn, (IRecipe<IInventory>)p_217056_2_, p_217056_1_);
   }
