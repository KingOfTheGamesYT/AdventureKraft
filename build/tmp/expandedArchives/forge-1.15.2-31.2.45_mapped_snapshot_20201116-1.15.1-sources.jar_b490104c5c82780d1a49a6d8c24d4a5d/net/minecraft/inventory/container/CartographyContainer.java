...
public class CartographyContainer extends Container {
   ...
   public CartographyContainer(int id, PlayerInventory playerInventoryIn) {
      this(id, playerInventoryIn, IWorldPosCallable.DUMMY);
   }

   public CartographyContainer(int id, PlayerInventory playerInventoryIn, final IWorldPosCallable worldPosCallable) {
