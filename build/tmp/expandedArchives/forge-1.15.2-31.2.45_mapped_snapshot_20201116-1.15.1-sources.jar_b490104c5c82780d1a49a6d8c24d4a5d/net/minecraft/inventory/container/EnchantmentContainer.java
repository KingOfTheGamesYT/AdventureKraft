...
public class EnchantmentContainer extends Container {
   ...
   public EnchantmentContainer(int id, PlayerInventory playerInventoryIn) {
      this(id, playerInventoryIn, IWorldPosCallable.DUMMY);
   }

   public EnchantmentContainer(int id, PlayerInventory playerInventoryIn, IWorldPosCallable worldPosCallable) {
      ...
      this.trackInt(this.xpSeed).set(playerInventoryIn.player.getXPSeed());
