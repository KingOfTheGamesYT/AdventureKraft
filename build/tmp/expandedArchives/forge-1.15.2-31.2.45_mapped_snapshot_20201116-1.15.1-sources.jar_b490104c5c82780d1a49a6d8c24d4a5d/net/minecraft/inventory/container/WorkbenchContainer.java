...
public class WorkbenchContainer extends RecipeBookContainer<CraftingInventory> {
   ...
   public WorkbenchContainer(int id, PlayerInventory playerInventoryIn) {
      this(id, playerInventoryIn, IWorldPosCallable.DUMMY);
   }

   public WorkbenchContainer(int id, PlayerInventory playerInventoryIn, IWorldPosCallable p_i50090_3_) {
