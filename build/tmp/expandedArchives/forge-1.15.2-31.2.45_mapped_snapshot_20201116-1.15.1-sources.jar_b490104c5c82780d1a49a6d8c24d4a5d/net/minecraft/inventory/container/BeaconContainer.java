...
public class BeaconContainer extends Container {
   ...
   public BeaconContainer(int id, IInventory inventoryIn, IIntArray p_i50100_3_, IWorldPosCallable worldPosCallableIn) {
      ...
      for(int k = 0; k < 3; ++k) {
         for(int l = 0; l < 9; ++l) {
            this.addSlot(new Slot(inventoryIn, l + k * 9 + 9, 36 + l * 18, 137 + k * 18));
         }
      }

      for(int i1 = 0; i1 < 9; ++i1) {
         this.addSlot(new Slot(inventoryIn, i1, 36 + i1 * 18, 195));
      }
