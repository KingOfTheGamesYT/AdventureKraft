...
public class BlockItem extends Item {
   ...
   protected boolean canPlace(BlockItemUseContext context, BlockState blockStateIn) {
      ...
      return (!this.checkPosition() || blockStateIn.isValidPosition(context.getWorld(), context.getPos())) && context.getWorld().placedBlockWouldCollide(blockStateIn, context.getPos(), iselectioncontext);
   }
