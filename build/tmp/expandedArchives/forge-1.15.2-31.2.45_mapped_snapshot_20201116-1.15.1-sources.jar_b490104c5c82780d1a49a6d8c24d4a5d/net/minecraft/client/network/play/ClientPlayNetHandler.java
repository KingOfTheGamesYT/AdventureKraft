...
public class ClientPlayNetHandler implements IClientPlayNetHandler {
   ...
   /**
    * Gets a totem of undying ItemStack, trying to use a totem held in the main or off hand, but falling back to a newly
    * constructed stack if no totem is held. Thus, if the player is holding an enchanted totem, it will be rendered with
    * the enchantments.
    */
