...
public class SoundEngine {
   ...
   private void tickNonPaused() {
      ++this.ticks;
      this.tickableSoundsToPlayOnNextTick.forEach(this::play);
      this.tickableSoundsToPlayOnNextTick.clear();
                  ...
                  if (f1 == 0.0F && !p_sound.canBeSilent()) {
                     ...
                     channelmanager$entry.runOnSoundExecutor((p_217930_7_) -> {
                        ...
                        if (isound$attenuationtype == ISound.AttenuationType.LINEAR) {
                           p_217930_7_.setLinearAttenuation(f);
                        } else {
                           p_217930_7_.setNoAttenuation();
                        }
                     ...
                     if (!sound.isStreaming()) {
                        ...
                        this.audioStreamManager.createStreamingResource(sound.getSoundAsOggLocation()).thenAccept((p_217928_1_) -> {
   ...
   public void playOnNextTick(ITickableSound tickableSoundIn) {
      this.tickableSoundsToPlayOnNextTick.add(tickableSoundIn);
   }
