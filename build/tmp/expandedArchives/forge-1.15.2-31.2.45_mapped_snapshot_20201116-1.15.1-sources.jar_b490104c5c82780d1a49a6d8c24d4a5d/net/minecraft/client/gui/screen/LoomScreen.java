...
public class LoomScreen extends ContainerScreen<LoomContainer> {
   ...
   public LoomScreen(LoomContainer containerIn, PlayerInventory playerInventoryIn, ITextComponent textComponentIn) {
      super(containerIn, playerInventoryIn, textComponentIn);
      this.modelRender = BannerTileEntityRenderer.getModelRender();
      containerIn.func_217020_a(this::containerChange);
   }
   ...
   protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
      ...
      this.blit(i + 119, j + 13 + k, 232 + (this.displayPatternsIn ? 0 : 12), 0, 12, 15);
      ...
      if (this.displayPatternsIn) {
         int i2 = i + 60;
         int k2 = j + 13;
         int i3 = this.indexStarting + 16;

         for(int l = this.indexStarting; l < i3 && l < BannerPattern.field_222480_O - 5; ++l) {
