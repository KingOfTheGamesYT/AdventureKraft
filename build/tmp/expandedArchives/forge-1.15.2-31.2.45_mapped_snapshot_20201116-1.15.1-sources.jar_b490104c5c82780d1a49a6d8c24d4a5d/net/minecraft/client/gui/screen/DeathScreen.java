...
public class DeathScreen extends Screen {
   ...
   public DeathScreen(@Nullable ITextComponent textComponentIn, boolean isHardcoreModeIn) {
      super(new TranslationTextComponent(isHardcoreModeIn ? "deathScreen.title.hardcore" : "deathScreen.title"));
      this.causeOfDeath = textComponentIn;
      this.isHardcoreMode = isHardcoreModeIn;
   }
