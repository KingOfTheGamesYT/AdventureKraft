...
public class ResourcePacksScreen extends SettingsScreen {
   ...
   public ResourcePacksScreen(Screen previousScreen, GameSettings gameSettingsObj) {
      super(previousScreen, gameSettingsObj, new TranslationTextComponent("resourcePack.title"));
   }
