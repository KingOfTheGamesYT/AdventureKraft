...
public class WorldSelectionScreen extends Screen {
   ...
   protected void init() {
      ...
      this.searchField = new TextFieldWidget(this.font, this.width / 2 - 100, 22, 200, 20, this.searchField, I18n.format("selectWorld.search"));
   ...
   public void render(int p_render_1_, int p_render_2_, float p_render_3_) {
      ...
      this.searchField.render(p_render_1_, p_render_2_, p_render_3_);
