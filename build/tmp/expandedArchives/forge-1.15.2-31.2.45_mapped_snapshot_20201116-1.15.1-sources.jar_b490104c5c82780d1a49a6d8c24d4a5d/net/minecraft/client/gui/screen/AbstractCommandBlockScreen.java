...
public abstract class AbstractCommandBlockScreen extends Screen {
   ...
   protected void init() {
      ...
      this.commandTextField = new TextFieldWidget(this.font, this.width / 2 - 150, 50, 300, 20, I18n.format("advMode.command")) {
         protected String getNarrationMessage() {
            return super.getNarrationMessage() + AbstractCommandBlockScreen.this.suggestionHelper.func_228129_c_();
         }
      };
   ...
   public boolean keyPressed(int p_keyPressed_1_, int p_keyPressed_2_, int p_keyPressed_3_) {
      if (this.suggestionHelper.onKeyPressed(p_keyPressed_1_, p_keyPressed_2_, p_keyPressed_3_)) {
         return true;
   ...
   public boolean mouseScrolled(double p_mouseScrolled_1_, double p_mouseScrolled_3_, double p_mouseScrolled_5_) {
      return this.suggestionHelper.onScroll(p_mouseScrolled_5_) ? true : super.mouseScrolled(p_mouseScrolled_1_, p_mouseScrolled_3_, p_mouseScrolled_5_);
   }

   public boolean mouseClicked(double p_mouseClicked_1_, double p_mouseClicked_3_, int p_mouseClicked_5_) {
      return this.suggestionHelper.onClick(p_mouseClicked_1_, p_mouseClicked_3_, p_mouseClicked_5_) ? true : super.mouseClicked(p_mouseClicked_1_, p_mouseClicked_3_, p_mouseClicked_5_);
   }
   ...
   public void render(int p_render_1_, int p_render_2_, float p_render_3_) {
      ...
      this.suggestionHelper.render(p_render_1_, p_render_2_);
   }
}
