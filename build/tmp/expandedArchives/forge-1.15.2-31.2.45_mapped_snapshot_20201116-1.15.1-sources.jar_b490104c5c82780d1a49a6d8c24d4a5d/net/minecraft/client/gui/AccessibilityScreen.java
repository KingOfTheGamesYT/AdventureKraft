...
public class AccessibilityScreen extends SettingsScreen {
   ...
   public AccessibilityScreen(Screen parentScreenIn, GameSettings p_i51123_2_) {
      super(parentScreenIn, p_i51123_2_, new TranslationTextComponent("options.accessibility.title"));
   }
