...
public class BookModel extends Model {
   ...
   /**
    * Renders all the parts of the book.
    */
   public void renderAll(MatrixStack matrixStackIn, IVertexBuilder bufferIn, int packedLightIn, int packedOverlayIn, float red, float green, float blue, float alpha) {
      this.bookParts.forEach((p_228248_8_) -> {
         p_228248_8_.render(matrixStackIn, bufferIn, packedLightIn, packedOverlayIn, red, green, blue, alpha);
      });
   }

   /**
    * Sets the state of the book, including how open/closed it is and how far the left and right pages are flipped.
    *  
