...
public class JSONUtils {
   ...
   /**
    * Gets the long value of the given JsonElement. Expects the second parameter to be the name of the element's field
    * if an error message needs to be thrown.
    */
   ...
   /**
    * Gets the long value of the field on the JsonObject with the given name.
    */
   public static long getLong(JsonObject object, String memberName) {
      if (object.has(memberName)) {
         return getLong(object.get(memberName), memberName);
      } else {
   ...
   /**
    * Gets the long value of the field on the JsonObject with the given name, or the given default value if the field is
    * missing.
    */
   ...
   /**
    * Gets the byte value of the field on the JsonObject with the given name, or the given default value if the field is
    * missing.
    */
   ...
   public static JsonObject fromJson(Reader readerIn, boolean lenient) {
      return fromJson(GSON, readerIn, JsonObject.class, lenient);
   }
   ...
   public static JsonObject fromJson(Reader readerIn) {
      return fromJson(readerIn, false);
   }
}
