...
public class WorldOptimizer {
   ...
   public WorldOptimizer(String p_i50400_1_, SaveFormat p_i50400_2_, WorldInfo worldInfoIn, boolean p_i50400_4_) {
      this.worldName = worldInfoIn.getWorldName();
      this.field_219957_d = p_i50400_4_;
      this.worldStorage = p_i50400_2_.getSaveLoader(p_i50400_1_, (MinecraftServer)null);
      this.worldStorage.saveWorldInfo(worldInfoIn);
