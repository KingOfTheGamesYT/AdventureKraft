   ...
   public static Iterable<BlockPos> getAllInBoxMutable(int x1, int y1, int z1, int x2, int y2, int z2) {
      return () -> {
         return new AbstractIterator<BlockPos>() {
            final CubeCoordinateIterator coordinateIterator = new CubeCoordinateIterator(x1, y1, z1, x2, y2, z2);
            final BlockPos.Mutable mutablePos = new BlockPos.Mutable();

            protected BlockPos computeNext() {
               return (BlockPos)(this.coordinateIterator.hasNext() ? this.mutablePos.setPos(this.coordinateIterator.getX(), this.coordinateIterator.getY(), this.coordinateIterator.getZ()) : this.endOfData());
            }
         };
      };
   }
