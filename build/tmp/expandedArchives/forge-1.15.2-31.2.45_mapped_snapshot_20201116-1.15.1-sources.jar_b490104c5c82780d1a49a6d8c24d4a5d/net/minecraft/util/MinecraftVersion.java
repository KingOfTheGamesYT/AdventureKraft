...
public class MinecraftVersion implements GameVersion {
   ...
   protected MinecraftVersion(JsonObject object) {
      this.id = JSONUtils.getString(object, "id");
      this.name = JSONUtils.getString(object, "name");
      this.releaseTarget = JSONUtils.getString(object, "release_target");
      this.stable = JSONUtils.getBoolean(object, "stable");
      this.worldVersion = JSONUtils.getInt(object, "world_version");
      this.protocolVersion = JSONUtils.getInt(object, "protocol_version");
      this.packVersion = JSONUtils.getInt(object, "pack_version");
      this.buildTime = Date.from(ZonedDateTime.parse(JSONUtils.getString(object, "build_time")).toInstant());
   }
