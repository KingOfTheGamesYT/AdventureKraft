...
public abstract class Fluid extends net.minecraftforge.registries.ForgeRegistryEntry<Fluid> implements net.minecraftforge.common.extensions.IForgeFluid {
   ...
   protected abstract boolean canDisplace(IFluidState fluidStateIn, IBlockReader blockReader, BlockPos pos, Fluid fluidIn, Direction directionIn);

   protected abstract Vec3d getFlow(IBlockReader blockReader, BlockPos pos, IFluidState fluidStateIn);
