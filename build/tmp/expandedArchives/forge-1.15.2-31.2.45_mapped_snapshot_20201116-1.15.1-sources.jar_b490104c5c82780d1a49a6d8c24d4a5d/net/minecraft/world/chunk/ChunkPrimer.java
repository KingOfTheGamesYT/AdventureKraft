...
public class ChunkPrimer implements IChunk {
   ...
   public ChunkPrimer(ChunkPos chunkPosIn, UpgradeData data) {
      this(chunkPosIn, data, (ChunkSection[])null, new ChunkPrimerTickList<>((p_205332_0_) -> {
         return p_205332_0_ == null || p_205332_0_.getDefaultState().isAir();
      }, chunkPosIn), new ChunkPrimerTickList<>((p_205766_0_) -> {
         return p_205766_0_ == null || p_205766_0_ == Fluids.EMPTY;
      }, chunkPosIn));
   }

   public ChunkPrimer(ChunkPos chunkPosIn, UpgradeData p_i49941_2_, @Nullable ChunkSection[] sectionsIn, ChunkPrimerTickList<Block> blockTickListIn, ChunkPrimerTickList<Fluid> p_i49941_5_) {
      this.pos = chunkPosIn;
   ...
   public void setBiomes(BiomeContainer biomesIn) {
