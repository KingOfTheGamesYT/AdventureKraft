            ...
            for(int l1 = 0; l1 < k; ++l1) {
               ...
               for(int i2 = 0; !flag && i2 < 4; ++i2) {
                  ...
                  if (biome$spawnlistentry.entityType.isSummonable() && canCreatureTypeSpawnAtLocation(EntitySpawnPlacementRegistry.PlacementType.ON_GROUND, worldIn, blockpos, biome$spawnlistentry.entityType)) {
                     ...
                     if (!worldIn.hasNoCollisions(biome$spawnlistentry.entityType.getBoundingBoxWithSizeApplied(d0, (double)blockpos.getY(), d1)) || !EntitySpawnPlacementRegistry.func_223515_a(biome$spawnlistentry.entityType, worldIn, SpawnReason.CHUNK_GENERATION, new BlockPos(d0, (double)blockpos.getY(), d1), worldIn.getRandom())) {
                        continue;
                     }
