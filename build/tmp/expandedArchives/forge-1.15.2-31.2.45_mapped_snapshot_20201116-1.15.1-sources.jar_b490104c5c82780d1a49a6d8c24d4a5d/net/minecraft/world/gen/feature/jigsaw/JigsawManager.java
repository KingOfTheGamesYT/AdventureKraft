...
public class JigsawManager {
   ...
   public static void addPieces(ResourceLocation structureLocation, int maxDepth, JigsawManager.IPieceFactory pieceFactory, ChunkGenerator<?> chunkGeneratorIn, TemplateManager templateManagerIn, BlockPos posIn, List<StructurePiece> structurePieces, Random rand) {
      Structures.init();
      new JigsawManager.Assembler(structureLocation, maxDepth, pieceFactory, chunkGeneratorIn, templateManagerIn, posIn, structurePieces, rand);
   }
   ...
   static final class Assembler {
      ...
      public Assembler(ResourceLocation resourceLocationIn, int p_i50691_2_, JigsawManager.IPieceFactory p_i50691_3_, ChunkGenerator<?> p_i50691_4_, TemplateManager templateManagerIn, BlockPos p_i50691_6_, List<StructurePiece> p_i50691_7_, Random rand) {
         ...
         int k = p_i50691_4_.getNoiseHeight(i, j, Heightmap.Type.WORLD_SURFACE_WG);
