...
public class LazyAreaLayerContext implements IExtendedNoiseRandom<LazyArea> {
   ...
   public LazyArea makeArea(IPixelTransformer pixelFactory, LazyArea firstArea, LazyArea secondArea) {
      return new LazyArea(this.cache, Math.min(1024, Math.max(firstArea.getmaxCacheSize(), secondArea.getmaxCacheSize()) * 4), pixelFactory);
   }
