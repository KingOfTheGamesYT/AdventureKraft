...
public class BlockClusterFeatureConfig implements IFeatureConfig {
   ...
   private BlockClusterFeatureConfig(BlockStateProvider stateProviderIn, BlockPlacer blockPlacerIn, Set<Block> whitelistIn, Set<BlockState> p_i225836_4_, int p_i225836_5_, int p_i225836_6_, int p_i225836_7_, int p_i225836_8_, boolean p_i225836_9_, boolean p_i225836_10_, boolean p_i225836_11_) {
      this.stateProvider = stateProviderIn;
      this.blockPlacer = blockPlacerIn;
