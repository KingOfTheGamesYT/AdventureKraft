...
public abstract class AbstractTreeFeature<T extends BaseTreeFeatureConfig> extends Feature<T> {
   ...
   /**
    * Attempts to set the log block at the specific location, returns true if it is able to. Is used as part of the
    * trunk generation.
    */
   ...
   /**
    * Attempts to set the log block at the specific location, returns true if it is able to. Is used as part of the leaf
    * generation.
    */
   protected boolean setLeaf(IWorldGenerationReader p_227219_1_, Random p_227219_2_, BlockPos p_227219_3_, Set<BlockPos> p_227219_4_, MutableBoundingBox p_227219_5_, BaseTreeFeatureConfig p_227219_6_) {
   ...
   protected void setBlockState(IWorldWriter worldIn, BlockPos pos, BlockState state) {
      this.setBlockStateNoReaction(worldIn, pos, state);
   }

   protected final void setBlockState(IWorldWriter p_227217_1_, BlockPos p_227217_2_, BlockState p_227217_3_, MutableBoundingBox p_227217_4_) {
      this.setBlockStateNoReaction(p_227217_1_, p_227217_2_, p_227217_3_);
      p_227217_4_.expandTo(new MutableBoundingBox(p_227217_2_, p_227217_2_));
   }

   private void setBlockStateNoReaction(IWorldWriter p_208521_1_, BlockPos p_208521_2_, BlockState p_208521_3_) {
            ...
            for(Direction direction : Direction.values()) {
               ...
               if (!p_227214_3_.contains(blockpos$pooledmutable)) {
                  ...
                  if (blockstate.has(BlockStateProperties.DISTANCE_1_7)) {
                     ...
                     this.setBlockStateNoReaction(p_227214_1_, blockpos$pooledmutable, blockstate.with(BlockStateProperties.DISTANCE_1_7, Integer.valueOf(1)));
                  ...
                  if (!set.contains(blockpos$pooledmutable) && !set1.contains(blockpos$pooledmutable)) {
                     ...
                     if (blockstate1.has(BlockStateProperties.DISTANCE_1_7)) {
                        ...
                        if (k > l + 1) {
                           ...
                           this.setBlockStateNoReaction(p_227214_1_, blockpos$pooledmutable, blockstate2);
                           if (p_227214_2_.isVecInside(blockpos$pooledmutable)) {
                              voxelshapepart.setFilled(blockpos$pooledmutable.getX() - p_227214_2_.minX, blockpos$pooledmutable.getY() - p_227214_2_.minY, blockpos$pooledmutable.getZ() - p_227214_2_.minZ, true, true);
                           }
