...
public class WorldGenRegion implements IWorld {
   ...
   public boolean destroyBlock(BlockPos pos, boolean isMoving, @Nullable Entity entityIn) {
      ...
      if (blockstate.isAir(this, pos)) {
         ...
         if (isMoving) {
            ...
            Block.spawnDrops(blockstate, this.world, pos, tileentity, entityIn, ItemStack.EMPTY);
         }
