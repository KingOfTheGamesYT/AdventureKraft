...
public class IglooPieces {
   ...
   private static final Map<ResourceLocation, BlockPos> field_207621_d = ImmutableMap.of(IGLOO_TOP, new BlockPos(3, 5, 5), IGLOO_MIDDLE, new BlockPos(1, 3, 1), IGLOO_BOTTOM, new BlockPos(3, 6, 7));
   private static final Map<ResourceLocation, BlockPos> field_207622_e = ImmutableMap.of(IGLOO_TOP, BlockPos.ZERO, IGLOO_MIDDLE, new BlockPos(2, -3, 4), IGLOO_BOTTOM, new BlockPos(0, -3, -2));
   ...
   public static void func_207617_a(TemplateManager p_207617_0_, BlockPos p_207617_1_, Rotation p_207617_2_, List<StructurePiece> p_207617_3_, Random p_207617_4_, NoFeatureConfig p_207617_5_) {
      if (p_207617_4_.nextDouble() < 0.5D) {
         ...
         p_207617_3_.add(new IglooPieces.Piece(p_207617_0_, IGLOO_BOTTOM, p_207617_1_, p_207617_2_, i * 3));

         for(int j = 0; j < i - 1; ++j) {
            p_207617_3_.add(new IglooPieces.Piece(p_207617_0_, IGLOO_MIDDLE, p_207617_1_, p_207617_2_, j * 3));
         }
      }

      p_207617_3_.add(new IglooPieces.Piece(p_207617_0_, IGLOO_TOP, p_207617_1_, p_207617_2_, 0));
   }
   ...
   public static class Piece extends TemplateStructurePiece {
      ...
      public boolean create(IWorld worldIn, ChunkGenerator<?> chunkGeneratorIn, Random randomIn, MutableBoundingBox mutableBoundingBoxIn, ChunkPos chunkPosIn) {
         ...
         if (this.field_207615_d.equals(IglooPieces.IGLOO_TOP)) {
