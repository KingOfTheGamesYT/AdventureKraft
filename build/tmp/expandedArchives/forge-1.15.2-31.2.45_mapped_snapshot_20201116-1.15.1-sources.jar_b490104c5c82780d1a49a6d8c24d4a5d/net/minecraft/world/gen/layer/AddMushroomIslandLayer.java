...
public enum AddMushroomIslandLayer implements IBishopTransformer {
   ...
   public int apply(INoiseRandom context, int x, int southEast, int p_202792_4_, int p_202792_5_, int p_202792_6_) {
      return LayerUtil.isShallowOcean(p_202792_6_) && LayerUtil.isShallowOcean(p_202792_5_) && LayerUtil.isShallowOcean(x) && LayerUtil.isShallowOcean(p_202792_4_) && LayerUtil.isShallowOcean(southEast) && context.random(100) == 0 ? MUSHROOM_FIELDS : p_202792_6_;
   }
}
