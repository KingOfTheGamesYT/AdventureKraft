...
public class TreeFeatureConfig extends BaseTreeFeatureConfig {
   ...
   public static <T> TreeFeatureConfig deserializeFoliage(Dynamic<T> dynamic) {
   ...
   public static <T> TreeFeatureConfig deserializeJungle(Dynamic<T> data) {
      return deserializeFoliage(data).setSapling((net.minecraftforge.common.IPlantable)net.minecraft.block.Blocks.JUNGLE_SAPLING);
   }

   public static <T> TreeFeatureConfig deserializeAcacia(Dynamic<T> data) {
      return deserializeFoliage(data).setSapling((net.minecraftforge.common.IPlantable)net.minecraft.block.Blocks.ACACIA_SAPLING);
   }
