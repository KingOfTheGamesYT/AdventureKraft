...
public class JigsawPattern {
   ...
   public JigsawPattern(ResourceLocation nameIn, ResourceLocation fallbackIn, List<Pair<JigsawPiece, Integer>> rawTemplatesIn, JigsawPattern.PlacementBehaviour placementBehaviourIn) {
      this.name = nameIn;
      this.rawTemplates = ImmutableList.copyOf(rawTemplatesIn);
      this.jigsawPieces = Lists.newArrayList();

      for(Pair<JigsawPiece, Integer> pair : rawTemplatesIn) {
