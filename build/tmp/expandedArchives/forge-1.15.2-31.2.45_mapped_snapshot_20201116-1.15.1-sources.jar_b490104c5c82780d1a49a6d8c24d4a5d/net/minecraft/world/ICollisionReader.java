...
public interface ICollisionReader extends IBlockReader {
   ...
   /**
    * Checks whether or not placing a block at the given position would cause a direct collision
    */
   default boolean placedBlockWouldCollide(BlockState pos, BlockPos p_226663_2_, ISelectionContext context) {
      VoxelShape voxelshape = pos.getCollisionShape(this, p_226663_2_, context);
