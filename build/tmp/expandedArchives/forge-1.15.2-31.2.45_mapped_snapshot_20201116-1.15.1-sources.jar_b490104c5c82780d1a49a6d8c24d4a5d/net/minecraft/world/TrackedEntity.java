...
public class TrackedEntity {
   ...
   public TrackedEntity(ServerWorld serverWorldIn, Entity entityIn, int p_i50704_3_, boolean p_i50704_4_, Consumer<IPacket<?>> p_i50704_5_) {
      this.world = serverWorldIn;
      ...
      this.encodedRotationYawHead = MathHelper.floor(entityIn.getRotationYawHead() * 256.0F / 360.0F);
