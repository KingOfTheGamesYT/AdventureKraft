...
public class ChunkHolder {
   ...
   public ChunkHolder(ChunkPos chunkPosIn, int levelIn, WorldLightManager lightManagerIn, ChunkHolder.IListener p_i50716_4_, ChunkHolder.IPlayerProvider playerProviderIn) {
      this.pos = chunkPosIn;
      this.lightManager = lightManagerIn;
      this.field_219327_v = p_i50716_4_;
      this.playerProvider = playerProviderIn;
