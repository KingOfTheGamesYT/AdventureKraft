...
public class CreeperRepellent extends BlockTorch {
    ...
    private void findSomethingToRepell(World par1World, int par2, int par3, int par4) {
        AxisAlignedBB bb = AxisAlignedBB.getBoundingBox((double)par2 - 20.0D, (double)par3 - 10.0D, (double)par4 - 20.0D, (double)par2 + 20.0D, (double)par3 + 10.0D, (double)par4 + 20.0D);
