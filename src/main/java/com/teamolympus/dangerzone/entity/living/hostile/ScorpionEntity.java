...
import com.teamolympus.dangerzone.entity.ai.DZAIAttackOnCollide;
import com.teamolympus.dangerzone.entity.ai.DZAINearestAttackableTarget;
...
public class ScorpionEntity extends EntityMob {
    ...
    public void addGoals() {
        ...
        this.tasks.addTask(2, new DZAIAttackOnCollide(this, EntityPlayer.class, 1.0D, false));
        ...
        this.targetTasks.addTask(2, new DZAINearestAttackableTarget(this, EntityPlayer.class, 0, true));
    }
