...
public class MantisAIAttackOnCollide extends EntityAIBase {
    ...
    public MantisAIAttackOnCollide(EntityCreature creature, Class clazz, double speed, boolean longMem) {

        this.classTarget = clazz;
    }

    public MantisAIAttackOnCollide(EntityCreature creature, double speed, boolean longMem) {
    ...
    public void updateTask()
    {
        ...
        float distance = entitylivingbase.getDistanceToEntity(attacker);

        if (attacker.attackTime <= 0 && distance < 2.0F && entitylivingbase.boundingBox.maxY > attacker.boundingBox.minY && entitylivingbase.boundingBox.minY < attacker.boundingBox.maxY)
        {
            attacker.attackTime = 20;
