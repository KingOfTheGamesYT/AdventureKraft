...
public class ContainerGuardInventory extends Container {
    ...
    private BodyguardEntity theHorse;
    private static final String __OBFID = "CL_00001751";

    public ContainerGuardInventory(IInventory p_i1817_1_, final IInventory p_i1817_2_, final BodyguardEntity p_i1817_3_)
    {
        ...
        this.addSlotToContainer(new Slot(p_i1817_2_, 0, 8, 18)
        {
            ...
            {
                return super.isItemValid(p_75214_1_) && !this.getHasStack();
            }
        });
        ...
        if (p_i1817_3_.isTamed() /**.isChested()**/)
        {
            for (j = 0; j < b0; ++j)
            {
                for (k = 0; k < 5; ++k)
