...
public class GuiScreenGuardInventory extends GuiContainer {
    ...
    private BodyguardEntity field_147034_x;
    private float field_147033_y;
    private float field_147032_z;
    private static final String __OBFID = "CL_00000760";

    public GuiScreenGuardInventory(IInventory p_i1093_1_, IInventory p_i1093_2_, BodyguardEntity p_i1093_3_)
    {
        super(new ContainerGuardInventory(p_i1093_1_, p_i1093_2_, p_i1093_3_));
