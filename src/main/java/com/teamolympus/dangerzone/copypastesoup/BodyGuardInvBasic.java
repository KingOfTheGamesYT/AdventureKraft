...
public class BodyGuardInvBasic implements IInventory {

    private String inventoryTitle;
    private int slotsCount;
    private ItemStack[] inventoryContents;
    private List slotsList;
    private boolean hasInvName;
    private static final String __OBFID = "CL_00001514";

    public BodyGuardInvBasic(String inventoryTitle, boolean hasInvName, int slotCount)
    {
        this.inventoryTitle = inventoryTitle;
        this.hasInvName = hasInvName;
        this.slotsCount = slotCount;
        this.inventoryContents = new ItemStack[slotCount];
    }

    public void func_110134_a(BodyGuardInvBasic p_110134_1_)
    {
        ...
        this.slotsList.add(p_110134_1_);
    }

    public void func_110132_b(BodyGuardInvBasic p_110132_1_)
    {
        this.slotsList.remove(p_110132_1_);
    }
    ...
    public void markDirty()
    {
        if (this.slotsList != null)
        {
            ...
            {
                ((GuardIInvBasic)this.slotsList.get(i)).onInventoryChanged(this);
            }
        }
    }
