...
public class BaseBlock extends Block implements IGrowable {
    ...
    private boolean glassLike = false;

    public BaseBlock(Properties properties, int xpdropped, boolean isGrowable, boolean canSustainPlants, DamageSource damageSource) {
        super(properties);
    ...
    public BaseBlock setGlassLike(boolean value) {
        this.glassLike = value;
        return this;
    }

    public BaseBlock silkTouchOnlyDrop(boolean value) {
        this.silkTouchOnlyDrop = value;
        return this;
    }

    public BaseBlock setEntityDamage(float amount) {
        this.damageAmount = amount;
        return this;
    }

    public BaseBlock addDamageTarget(Class<? extends Entity> entity) {
        this.damageTargets.add(entity);
        return this;
    }

    public BaseBlock addSpawnEntity(RegistryObject<? extends EntityType<?>> entity, int count) {
        this.spawnEntities.put(entity, count);
        return this;
    }

    public BaseBlock setRandomSpawn(boolean value) {
    ...
    public BaseBlock addInfo(String... newInfo) {
    ...
    public boolean isSideInvisible(BlockState state, BlockState adjacentBlockState, Direction side) {
        if (glassLike && adjacentBlockState.getBlock() == this) {
            return true;
        }
    ...
    public float getAmbientOcclusionLightValue(BlockState state, IBlockReader world, BlockPos pos) {
        return glassLike ? 1.0F : super.getAmbientOcclusionLightValue(state, world, pos);
    }

    @Override
    public boolean propagatesSkylightDown(BlockState state, IBlockReader reader, BlockPos pos) {
        return glassLike || super.propagatesSkylightDown(state, reader, pos);
    }
