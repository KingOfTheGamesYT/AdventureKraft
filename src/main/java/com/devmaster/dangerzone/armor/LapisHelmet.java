...
public class LapisHelmet extends ArmorItem {
    ...
    public void addInformation(ItemStack stack, World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
        tooltip.add(new StringTextComponent("\u00A79" + "Comes with Protection, Aqua Affinity, Respiration and Projectile Protection, This is for those that want to look seriously spiffy. Built for general awesomeness, it's right at home on the battlefield, the rugby field, the boardroom, or the dance floor.\n" + "\u00A79"));
