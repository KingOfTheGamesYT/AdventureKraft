...
public class RegistryHandler {
    ...
    public static final RegistryObject<Block> URANIUM_BLOCK = registerWIPBlock("uranium_block",() -> new ABlock(AbstractBlock.Properties.create(Material.ROCK).hardnessAndResistance(5.0F, 5.0F).sound(SoundType.METAL).harvestLevel(0).harvestTool(ToolType.PICKAXE).setRequiresTool().setLightLevel(state -> 2), 0).addInfo("\u00A7e" + "A nice yellow block!" + "\u00A7e"));
    ...
    public static final RegistryKey<World> ZOO = RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation(DangerZone.MOD_ID, "zoo"));
  ...
  /*  public static final RegistryObject<EntityType<Hydrolisc>> HYDROLISC = ENTITIES
   ...
   public static final RegistryObject<EntityType<Termite>> TERMITE = ENTITIES
    ...
    public static final RegistryObject<Item> BUGZILLA_SCALE = ITEMS.register("bugzilla_scale",() -> new AItem(DangerZone.TAB).addInfo("\u00A7b" + "It's Bugzilla!!" + "\u00A7b"));
    ...
    public static final RegistryObject<Item> CRYSTAL_CORN = ITEMS.register("crystal_corn", () -> new Consumable(64, Rarity.COMMON, DangerZone.FOOD).hunger(8,0.3F).action(UseAction.EAT).addInfo("\u00A74" + "American heirloom" + "\u00A74"));
    ...
    public static final RegistryObject<Item> JADE = ITEMS.register("jade", () -> new AItem(DangerZone.TAB).addInfo("\u00A72" + "Jaded" + "\u00A72"));
    ...
    public static final RegistryObject<ArmorItem> GODZILLA_CHESTPLATE = ITEMS.register("godzilla_chestplate", () -> new Armour(new ArmourTier("dangerzone:godzilla", DZConfig.GODZILLA_CHESTPLATE_DURABILITY.get(), DZConfig.GODZILLA_CHESTPLATE_ARMOR.get(), DZConfig.GODZILLA_CHESTPLATE_ENCHANTABILITY.get(), DZConfig.GODZILLA_CHESTPLATE_TOUGHNESS.get(), DZConfig.GODZILLA_CHESTPLATE_KNOCK_BACK_RESISTANCE.get(), false, Items.AIR), EquipmentSlotType.CHEST, Rarity.COMMON, DZConfig.GODZILLA_CHESTPLATE_HIT_COST.get()).addInfo("\u00A75" + "The best of the best!" + "\u00A75"));
