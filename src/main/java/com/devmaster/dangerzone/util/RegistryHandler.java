...
import static com.devmaster.dangerzone.items.ATool.SWORD;
...
public class RegistryHandler {
    ...
    public static final RegistryObject<Block> DARK_ORANGE_BLOCK = registerNormalBlock("dark_orange_block", () -> new ABlock(AbstractBlock.Properties.create(Material.ROCK).hardnessAndResistance( 1.0F,1.0F).harvestLevel(0).harvestTool(ToolType.PICKAXE).setRequiresTool().sound(SoundType.STONE),0,false,false,null).addInfo("\u00A76" + "Not annoying" + "\u00A7"));
   ...
   //public static final RegistryObject<Block> RED_BLOCK = registerNormalBlock("red_block", () -> new ABlock(AbstractBlock.Properties.create(Material.ROCK).hardnessAndResistance(1.0F, 1.0F).sound(SoundType.STONE).harvestLevel(0).harvestTool(ToolType.PICKAXE).setRequiresTool(), 0).addInfo("\u00A7c" + "Best color" + "\u00A7c"));
    ...
    //Generation
    public static final RegistryObject<Block> CRYSTAL_GRASS = registerNormalBlock("crystal_grass", () -> new ABlock(AbstractBlock.Properties.create(Material.EARTH).hardnessAndResistance(0.6F, 2.0F).sound(SoundType.STONE).harvestLevel(0).notSolid(),0,false, true,null).addInfo("\u00A7b" + "Similar to grass in the overworld." + "\u00A7b"));
    public static final RegistryObject<Block> KYANITE = registerNormalBlock("kyanite", () -> new ABlock(AbstractBlock.Properties.create(Material.ROCK).hardnessAndResistance(2.0F, 10.0F).sound(SoundType.STONE).harvestLevel(0).harvestTool(ToolType.PICKAXE).setRequiresTool().notSolid(),0,false,false,null).addInfo("\u00A7b" + "Similar to stone in the overworld. Use for Kyanite tools and weapons, but not armor. Also makes a nice Crystal Furnace, which is much faster and more fun to watch than a regular stone furnace! Pronounced: ki-an-ite" + "\u00A7b"));
    ...
    public static final RegistryObject<Block> HEART_BLOCK = registerWIPBlock("heart_block", () -> new ABlock(AbstractBlock.Properties.create(Material.SAND).hardnessAndResistance( 0.6F).sound(SoundType.GROUND),0,false,false,null).addInfo("\u00A7f" + "This block loves you" + "\u00A7f"));
    ...
    //Trees
    public static final RegistryObject<Block> APPLE_BLOCK =registerNormalBlock("apple_block", () -> new ABlock(AbstractBlock.Properties.create(Material.EARTH).hardnessAndResistance( 1F,1F).harvestLevel(1).sound(SoundType.PLANT),0,false,false,null).addInfo("\u00A7c" + "So red, so wonderful" + "\u00A7c"));
    public static final RegistryObject<Block> APPLE_LEAVES = registerWIPBlock("apple_leaves", () -> new ABlock(AbstractBlock.Properties.create(Material.LEAVES).hardnessAndResistance( 0.2F, 0.2F).harvestLevel(0).notSolid().sound(SoundType.PLANT),0,false,false,null).addInfo("\u00A7a" + "Apples from the trees" + "\u00A7a"));
  ...
  /*  public static final RegistryObject<EntityType<Hydrolisc>> HYDROLISC = ENTITIES
   ...
   // public static final RegistryObject<Item> ALLOSAURUS_TOOTH = ITEMS.register("allosaurus_tooth", () -> new AItem(DangerZone.TAB).addInfo("\u00A7f" + "They don't wash their teeth" + "\u00A7f"));
    ...
    //Tools
    public static final RegistryObject<ATool> ALUMINIUM_AXE = ITEMS.register("aluminium_axe", () -> new ATool(new ModdedTier(DZConfig.ALUMINIUM_AXE_DURABILITY.get(), DZConfig.ALUMINIUM_AXE_DAMAGE.get(), DZConfig.ALUMINIUM_AXE_EFFICIENCY.get(), DZConfig.ALUMINIUM_AXE_ATTACK_SPEED.get()).level(DZConfig.ALUMINIUM_AXE_HARVEST_LEVEL.get()).enchanting(DZConfig.ALUMINIUM_AXE_ENCHANTABILITY.get()).material(RegistryHandler.ALUMINIUM.get()), ImmutableSet.of(ToolType.AXE), DZConfig.ALUMINIUM_AXE_HIT_COST.get()).addInfo("§fIt's Bri'ish"));
    public static final RegistryObject<ATool> ALUMINIUM_HOE = ITEMS.register("aluminium_hoe", () -> new ATool(new ModdedTier(DZConfig.ALUMINIUM_HOE_DURABILITY.get(), DZConfig.ALUMINIUM_HOE_DAMAGE.get(), DZConfig.ALUMINIUM_HOE_EFFICIENCY.get(), DZConfig.ALUMINIUM_HOE_ATTACK_SPEED.get()).level(DZConfig.ALUMINIUM_HOE_HARVEST_LEVEL.get()).enchanting(DZConfig.ALUMINIUM_HOE_ENCHANTABILITY.get()).material(RegistryHandler.ALUMINIUM.get()), ImmutableSet.of(ToolType.HOE), DZConfig.ALUMINIUM_HOE_HIT_COST.get()).addInfo("\u00A7f" + "Close to iron" + "\u00A7f"));
    public static final RegistryObject<ATool> ALUMINIUM_PICKAXE = ITEMS.register("aluminium_pickaxe", () -> new ATool(new ModdedTier(DZConfig.ALUMINIUM_PICKAXE_DURABILITY.get(), DZConfig.ALUMINIUM_PICKAXE_DAMAGE.get(), DZConfig.ALUMINIUM_PICKAXE_EFFICIENCY.get(), DZConfig.ALUMINIUM_PICKAXE_ATTACK_SPEED.get()).level(DZConfig.ALUMINIUM_PICKAXE_HARVEST_LEVEL.get()).enchanting(DZConfig.ALUMINIUM_PICKAXE_ENCHANTABILITY.get()).material(RegistryHandler.ALUMINIUM.get()), ImmutableSet.of(ToolType.PICKAXE), DZConfig.ALUMINIUM_PICKAXE_HIT_COST.get()).addInfo("\u00A7f" + "Same mining level as iron" + "\u00A7f"));
    public static final RegistryObject<ATool> ALUMINIUM_SHOVEL = ITEMS.register("aluminium_shovel", () -> new ATool(new ModdedTier(DZConfig.ALUMINIUM_SHOVEL_DURABILITY.get(), DZConfig.ALUMINIUM_SHOVEL_DAMAGE.get(), DZConfig.ALUMINIUM_SHOVEL_EFFICIENCY.get(), DZConfig.ALUMINIUM_SHOVEL_ATTACK_SPEED.get()).level(DZConfig.ALUMINIUM_SHOVEL_HARVEST_LEVEL.get()).enchanting(DZConfig.ALUMINIUM_SHOVEL_ENCHANTABILITY.get()).material(RegistryHandler.ALUMINIUM.get()), ImmutableSet.of(ToolType.SHOVEL), DZConfig.ALUMINIUM_SHOVEL_HIT_COST.get()).addInfo("\u00A7f" + "alumones" + "\u00A7f"));
    public static final RegistryObject<ATool> COARSE_AMETHYST_AXE = ITEMS.register("coarse_amethyst_axe", () -> new ATool(new ModdedTier(DZConfig.COARSE_AMETHYST_AXE_DURABILITY.get(), DZConfig.COARSE_AMETHYST_AXE_DAMAGE.get(), DZConfig.COARSE_AMETHYST_AXE_EFFICIENCY.get(), DZConfig.COARSE_AMETHYST_AXE_ATTACK_SPEED.get()).level(DZConfig.COARSE_AMETHYST_AXE_HARVEST_LEVEL.get()).enchanting(DZConfig.COARSE_AMETHYST_AXE_ENCHANTABILITY.get()).material(RegistryHandler.COARSE_AMETHYST.get()), ImmutableSet.of(ToolType.AXE), DZConfig.COARSE_AMETHYST_AXE_HIT_COST.get()).addInfo("\u00A75" + "Go berserk" + "\u00A75"));
    public static final RegistryObject<ATool> COARSE_AMETHYST_HOE = ITEMS.register("coarse_amethyst_hoe", () -> new ATool(new ModdedTier(DZConfig.COARSE_AMETHYST_HOE_DURABILITY.get(), DZConfig.COARSE_AMETHYST_HOE_DAMAGE.get(), DZConfig.COARSE_AMETHYST_HOE_EFFICIENCY.get(), DZConfig.COARSE_AMETHYST_HOE_ATTACK_SPEED.get()).level(DZConfig.COARSE_AMETHYST_HOE_HARVEST_LEVEL.get()).enchanting(DZConfig.COARSE_AMETHYST_HOE_ENCHANTABILITY.get()).material(RegistryHandler.COARSE_AMETHYST.get()), ImmutableSet.of(ToolType.HOE), DZConfig.COARSE_AMETHYST_HOE_HIT_COST.get()).addInfo("\u00A75" + "Why would you waste your Coarse Amethyst on this?" + "\u00A75"));
    public static final RegistryObject<ATool> COARSE_AMETHYST_PICKAXE = ITEMS.register("coarse_amethyst_pickaxe", () -> new ATool(new ModdedTier(DZConfig.COARSE_AMETHYST_PICKAXE_DURABILITY.get(), DZConfig.COARSE_AMETHYST_PICKAXE_DAMAGE.get(), DZConfig.COARSE_AMETHYST_PICKAXE_EFFICIENCY.get(), DZConfig.COARSE_AMETHYST_PICKAXE_ATTACK_SPEED.get()).level(DZConfig.COARSE_AMETHYST_PICKAXE_HARVEST_LEVEL.get()).enchanting(DZConfig.COARSE_AMETHYST_PICKAXE_ENCHANTABILITY.get()).material(RegistryHandler.COARSE_AMETHYST.get()), ImmutableSet.of(ToolType.PICKAXE),DZConfig.COARSE_AMETHYST_PICKAXE_HIT_COST.get()).addInfo("\u00A75" + "Go MINE YOUR DREAMS" + "\u00A75"));
    public static final RegistryObject<ATool> COARSE_AMETHYST_SHOVEL = ITEMS.register("coarse_amethyst_shovel", () -> new ATool(new ModdedTier(DZConfig.COARSE_AMETHYST_SHOVEL_DURABILITY.get(), DZConfig.COARSE_AMETHYST_SHOVEL_DAMAGE.get(), DZConfig.COARSE_AMETHYST_SHOVEL_EFFICIENCY.get(), DZConfig.COARSE_AMETHYST_SHOVEL_ATTACK_SPEED.get()).level(DZConfig.COARSE_AMETHYST_SHOVEL_HARVEST_LEVEL.get()).enchanting(DZConfig.COARSE_AMETHYST_SHOVEL_ENCHANTABILITY.get()).material(RegistryHandler.COARSE_AMETHYST.get()), ImmutableSet.of(ToolType.SHOVEL), DZConfig.COARSE_AMETHYST_SHOVEL_HIT_COST.get()).addInfo("\u00A75" + "Get all the dirt you want" + "\u00A75"));
    public static final RegistryObject<ATool> EMERALD_AXE = ITEMS.register("emerald_axe", () -> new ATool(new ModdedTier(DZConfig.EMERALD_AXE_DURABILITY.get(), DZConfig.EMERALD_AXE_DAMAGE.get(), DZConfig.EMERALD_AXE_EFFICIENCY.get(), DZConfig.EMERALD_AXE_ATTACK_SPEED.get()).level(DZConfig.EMERALD_AXE_HARVEST_LEVEL.get()).enchanting(DZConfig.EMERALD_AXE_ENCHANTABILITY.get()).material(Items.EMERALD), ImmutableSet.of(ToolType.AXE), DZConfig.EMERALD_AXE_HIT_COST.get()).addInfo("\u00A72" + "Show those greedy villagers true power" + "\u00A72"));
    public static final RegistryObject<ATool> EMERALD_HOE = ITEMS.register("emerald_hoe", () -> new ATool(new ModdedTier(DZConfig.EMERALD_HOE_DURABILITY.get(), DZConfig.EMERALD_HOE_DAMAGE.get(), DZConfig.EMERALD_HOE_EFFICIENCY.get(), DZConfig.EMERALD_HOE_ATTACK_SPEED.get()).level(DZConfig.EMERALD_HOE_HARVEST_LEVEL.get()).enchanting(DZConfig.EMERALD_HOE_ENCHANTABILITY.get()).material(Items.EMERALD), ImmutableSet.of(ToolType.HOE), DZConfig.EMERALD_HOE_HIT_COST.get()).addInfo("\u00A72" + "Show those greedy villagers how to farm" + "\u00A72"));
    public static final RegistryObject<ATool> EMERALD_PICKAXE = ITEMS.register("emerald_pickaxe", () -> new ATool(new ModdedTier(DZConfig.EMERALD_PICKAXE_DURABILITY.get(), DZConfig.EMERALD_PICKAXE_DAMAGE.get(), DZConfig.EMERALD_PICKAXE_EFFICIENCY.get(), DZConfig.EMERALD_PICKAXE_ATTACK_SPEED.get()).level(DZConfig.EMERALD_PICKAXE_HARVEST_LEVEL.get()).enchanting(DZConfig.EMERALD_PICKAXE_ENCHANTABILITY.get()).material(Items.EMERALD), ImmutableSet.of(ToolType.PICKAXE), DZConfig.EMERALD_PICKAXE_HIT_COST.get()).addInfo("\u00A72" + "Now you know why those greedy villagers love these green gems so much" + "\u00A72"));
    public static final RegistryObject<ATool> EMERALD_SHOVEL = ITEMS.register("emerald_shovel", () -> new ATool(new ModdedTier(DZConfig.EMERALD_SHOVEL_DURABILITY.get(), DZConfig.EMERALD_SHOVEL_DAMAGE.get(), DZConfig.EMERALD_SHOVEL_EFFICIENCY.get(), DZConfig.EMERALD_SHOVEL_ATTACK_SPEED.get()).level(DZConfig.EMERALD_SHOVEL_HARVEST_LEVEL.get()).enchanting(DZConfig.EMERALD_SHOVEL_ENCHANTABILITY.get()).material(Items.EMERALD), ImmutableSet.of(ToolType.SHOVEL), DZConfig.EMERALD_SHOVEL_HIT_COST.get()).addInfo("\u00A72" + "Show those greedy villagers how to get dirt" + "\u00A72"));
    public static final RegistryObject<ATool> GODZILLA_AXE = ITEMS.register("godzilla_axe", () -> new ATool(new ModdedTier(DZConfig.GODZILLA_AXE_DURABILITY.get(), DZConfig.GODZILLA_AXE_DAMAGE.get(), DZConfig.GODZILLA_AXE_EFFICIENCY.get(), DZConfig.GODZILLA_AXE_ATTACK_SPEED.get()).level(DZConfig.GODZILLA_AXE_HARVEST_LEVEL.get()).enchanting(DZConfig.GODZILLA_AXE_ENCHANTABILITY.get()).material(Items.AIR), ImmutableSet.of(ToolType.AXE), DZConfig.GODZILLA_AXE_HIT_COST.get()).addInfo("\u00A7f" + "Wait but it's MobZilla right?" + "\u00A7f"));
    public static final RegistryObject<ATool> SAPPHIRE_AXE = ITEMS.register("sapphire_axe", () -> new ATool(new ModdedTier(DZConfig.SAPPHIRE_AXE_DURABILITY.get(), DZConfig.SAPPHIRE_AXE_DAMAGE.get(), DZConfig.SAPPHIRE_AXE_EFFICIENCY.get(), DZConfig.SAPPHIRE_AXE_ATTACK_SPEED.get()).level(DZConfig.SAPPHIRE_AXE_HARVEST_LEVEL.get()).enchanting(DZConfig.SAPPHIRE_AXE_ENCHANTABILITY.get()).material(RegistryHandler.SAPPHIRE.get()), ImmutableSet.of(ToolType.AXE), DZConfig.SAPPHIRE_AXE_HIT_COST.get()).addInfo("\u00A79" + "Made out of my birth stone" + "\u00A79"));
    public static final RegistryObject<ATool> SAPPHIRE_HOE = ITEMS.register("sapphire_hoe", () -> new ATool(new ModdedTier(DZConfig.SAPPHIRE_HOE_DURABILITY.get(), DZConfig.SAPPHIRE_HOE_DAMAGE.get(), DZConfig.SAPPHIRE_HOE_EFFICIENCY.get(), DZConfig.SAPPHIRE_HOE_ATTACK_SPEED.get()).level(DZConfig.SAPPHIRE_HOE_HARVEST_LEVEL.get()).enchanting(DZConfig.SAPPHIRE_HOE_ENCHANTABILITY.get()).material(RegistryHandler.SAPPHIRE.get()), ImmutableSet.of(ToolType.HOE), DZConfig.SAPPHIRE_HOE_HIT_COST.get()).addInfo("\u00A79" + "Vibrant" + "\u00A79"));
    public static final RegistryObject<ATool> SAPPHIRE_PICKAXE = ITEMS.register("sapphire_pickaxe", () -> new ATool(new ModdedTier(DZConfig.SAPPHIRE_PICKAXE_DURABILITY.get(), DZConfig.SAPPHIRE_PICKAXE_DAMAGE.get(), DZConfig.SAPPHIRE_PICKAXE_EFFICIENCY.get(), DZConfig.SAPPHIRE_PICKAXE_ATTACK_SPEED.get()).level(DZConfig.SAPPHIRE_PICKAXE_HARVEST_LEVEL.get()).enchanting(DZConfig.SAPPHIRE_PICKAXE_ENCHANTABILITY.get()).material(RegistryHandler.SAPPHIRE.get()), ImmutableSet.of(ToolType.PICKAXE), DZConfig.SAPPHIRE_PICKAXE_HIT_COST.get()).addInfo("\u00A79" + "The pickaxe from Madagascar" + "\u00A79"));
    public static final RegistryObject<ATool> SAPPHIRE_SHOVEL = ITEMS.register("sapphire_shovel", () -> new ATool(new ModdedTier(DZConfig.SAPPHIRE_SHOVEL_DURABILITY.get(), DZConfig.SAPPHIRE_SHOVEL_DAMAGE.get(), DZConfig.SAPPHIRE_SHOVEL_EFFICIENCY.get(), DZConfig.SAPPHIRE_SHOVEL_ATTACK_SPEED.get()).level(DZConfig.SAPPHIRE_SHOVEL_HARVEST_LEVEL.get()).enchanting(DZConfig.SAPPHIRE_SHOVEL_ENCHANTABILITY.get()).material(RegistryHandler.SAPPHIRE.get()), ImmutableSet.of(ToolType.SHOVEL), DZConfig.SAPPHIRE_SHOVEL_HIT_COST.get()).addInfo("\u00A79" + "Wielder sits high on the throne" + "\u00A79"));
    ...
    //Weapons
    public static final RegistryObject<ATool> CAKE_SWORD = ITEMS.register("cake_sword", () -> new ATool(new ModdedTier(DZConfig.CAKE_SWORD_DURABILITY.get(), DZConfig.CAKE_SWORD_DAMAGE.get(), DZConfig.CAKE_SWORD_EFFICIENCY.get(),DZConfig.CAKE_SWORD_ATTACK_SPEED.get()).level(DZConfig.CAKE_SWORD_HARVEST_LEVEL.get()).enchanting(DZConfig.CAKE_SWORD_ENCHANTABILITY.get()).material(Items.CAKE), ImmutableSet.of(SWORD), DZConfig.CAKE_SWORD_HIT_COST.get()).addInfo("\u00A7f" + "Thank you for 2k downloads" + "\u00A7f"));
    public static final RegistryObject<ATool> COARSE_AMETHYST_SWORD = ITEMS.register("coarse_amethyst_sword", () -> new ATool(new ModdedTier(DZConfig.COARSE_AMETHYST_SWORD_DURABILITY.get(), DZConfig.COARSE_AMETHYST_SWORD_DAMAGE.get(), DZConfig.COARSE_AMETHYST_SWORD_EFFICIENCY.get(),DZConfig.COARSE_AMETHYST_SWORD_ATTACK_SPEED.get()).level(DZConfig.COARSE_AMETHYST_AXE_HARVEST_LEVEL.get()).enchanting(DZConfig.COARSE_AMETHYST_SWORD_ENCHANTABILITY.get()).material(RegistryHandler.COARSE_AMETHYST.get()), ImmutableSet.of(SWORD), DZConfig.COARSE_AMETHYST_SWORD_HIT_COST.get()).addInfo("\u00A75" + "Go destroy your foes" + "\u00A75"));
    public static final RegistryObject<Item> EMERALD_SWORD = ITEMS.register("emerald_sword", () -> new ATool(new ModdedTier(DZConfig.EMERALD_SWORD_DURABILITY.get(), DZConfig.EMERALD_SWORD_DAMAGE.get(), DZConfig.EMERALD_SWORD_EFFICIENCY.get(),DZConfig.EMERALD_SWORD_ATTACK_SPEED.get()).level(DZConfig.EMERALD_HOE_HARVEST_LEVEL.get()).enchanting(DZConfig.EMERALD_SWORD_ENCHANTABILITY.get()).material(Items.EMERALD), ImmutableSet.of(SWORD), DZConfig.EMERALD_SWORD_HIT_COST.get()).addInfo("\u00A72" + "Kill those greedy villagers" + "\u00A72"));
    ...
    //Ambient
    public static final RegistryObject<Block> BUTTERFLY_EGG_ORE = registerPetrifiedBlock("butterfly_egg_ore", () -> new ABlock(AbstractBlock.Properties.create(Material.ROCK).hardnessAndResistance( 2F,2F).harvestLevel(2).sound(SoundType.STONE).setRequiresTool(),0,false,false,null));

    //Ants
    public static final RegistryObject<Block> RAINBOW_ANT_EGG_ORE = registerPetrifiedBlock("rainbow_ant_egg_ore", () -> new ABlock(AbstractBlock.Properties.create(Material.ROCK).hardnessAndResistance( 2F,2F).harvestLevel(2).sound(SoundType.STONE).setRequiresTool(),0,false,false,null));
    public static final RegistryObject<Block> TERMITE_EGG_ORE = registerPetrifiedBlock("termite_egg_ore", () -> new ABlock(AbstractBlock.Properties.create(Material.ROCK).hardnessAndResistance( 2F,2F).harvestLevel(2).sound(SoundType.STONE).setRequiresTool(),0,false,false,null));

    //Bosses
    public static final RegistryObject<Block> GODZILLA_EGG_ORE = registerPetrifiedBlock("godzilla_egg_ore", () -> new ABlock(AbstractBlock.Properties.create(Material.ROCK).hardnessAndResistance( 2F,2F).harvestLevel(2).sound(SoundType.STONE).setRequiresTool(),0,false,false,null));
    public static final RegistryObject<Block> REDROSEWARRIOR_EGG_ORE = registerPetrifiedBlock("redrosewarrior_egg_ore", () -> new ABlock(AbstractBlock.Properties.create(Material.ROCK).hardnessAndResistance( 2F,2F).harvestLevel(2).sound(SoundType.STONE).setRequiresTool(),0,false,false,null));
    ...
    public static final RegistryObject<Block> MUTANT_ZOMBIE_EGG_ORE = registerPetrifiedBlock("mutant_zombie_egg_ore", () -> new ABlock(AbstractBlock.Properties.create(Material.ROCK).hardnessAndResistance( 2F,2F).harvestLevel(2).sound(SoundType.STONE).setRequiresTool(),0,false,false,null));
    public static final RegistryObject<Block> ZOMBIE_EGG_ORE = registerPetrifiedBlock("petrified_zombie_ore", () -> new ABlock(AbstractBlock.Properties.create(Material.ROCK).hardnessAndResistance( 2F,2F).harvestLevel(2).sound(SoundType.STONE).setRequiresTool(),0,false,false,null));

    //Youtubers
    public static final RegistryObject<Block> STAMPYLONGNOSE_EGG_ORE = registerPetrifiedBlock("petrified_stampylongnose_ore", () -> new ABlock(AbstractBlock.Properties.create(Material.ROCK).hardnessAndResistance( 2F,2F).harvestLevel(2).sound(SoundType.STONE).setRequiresTool(),0,false,false,null));
    public static final RegistryObject<Block> TEWTIY_EGG_ORE = registerPetrifiedBlock("petrified_tewtiy_ore", () -> new ABlock(AbstractBlock.Properties.create(Material.ROCK).hardnessAndResistance( 2F,2F).harvestLevel(2).sound(SoundType.STONE).setRequiresTool(),0,false,false,null));
