...
public class LapisChestplate extends ArmorItem {
    private static IArmorMaterial iArmorMaterial = new IArmorMaterial() {
        ...
        public int getDamageReductionAmount(EquipmentSlotType slotIn) {
            return (Integer) DZConfig.LAPIS_CHESTPLATE_ARMOR.get();
        }

        @Override
        public int getEnchantability() {
            return (Integer) DZConfig.LAPIS_CHESTPLATE_ENCHANTABILITY.get();
        }
        ...
        public float getToughness() {
            return (Integer) DZConfig.LAPIS_CHESTPLATE_TOUGHNESS.get();
        }

        @Override
        public float getKnockbackResistance() {
            return (Integer) DZConfig.LAPIS_CHESTPLATE_KNOCK_BACK_RESISTANCE.get();
        }
