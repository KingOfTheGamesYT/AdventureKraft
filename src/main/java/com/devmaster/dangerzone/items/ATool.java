...
public class ATool extends ToolItem {
    ...
    public ATool(ModdedTier tier, Set<ToolType> toolTypes, int hitCost) {
    ...
    public ATool addDefaultEnchantment(Enchantment enchantment, int level)
    {
    ...
    //Attributes
    public ATool reach(float value)
    {
        this.reach = value;
        rebuild();
        return this;
    ...
    public ATool movespeed(float value)
    {
    ...
    public ATool lifeSteal(float value)
    {
        this.lifeSteal = value;
        return this;
    }

    public ATool rebuild()
    {
        ImmutableMultimap.Builder<Attribute, AttributeModifier> builder = ImmutableMultimap.builder();
    ...
    //Tooltip
    public ATool addInfo(String... lines)
    {
        if (lines != null)
        {
