...
public class TitaniumPickaxe extends PickaxeItem {
    private static IItemTier iItemTier = new IItemTier() {
        ...
        public int getMaxUses() {
            return (Integer) DZConfig.TITANIUM_PICKAXE_DURABILITY.get();
        }

        public float getEfficiency() {
            return (Integer) DZConfig.TITANIUM_PICKAXE_EFFICIENCY.get();
        }
        ...
        public int getHarvestLevel() {
            return (Integer) DZConfig.TITANIUM_PICKAXE_HARVEST_LEVEL.get();
        }
    ...
    public TitaniumPickaxe() {
        super(iItemTier, (Integer)DZConfig.TITANIUM_PICKAXE_DAMAGE.get(), (Integer) DZConfig.TITANIUM_PICKAXE_ATTACK_SPEED.get(), (new Properties()).group(DangerZone.TOOLS));
    }
