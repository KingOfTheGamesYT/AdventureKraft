...
public class CopperLeggings extends ArmorItem {
    private static IArmorMaterial iArmorMaterial = new IArmorMaterial() {
        ...
        public int getDamageReductionAmount(EquipmentSlotType slotIn) {
            return (Integer) DZConfig.COPPER_LEGGINGS_ARMOR.get();
        }

        @Override
        public int getEnchantability() {
            return (Integer) DZConfig.COPPER_LEGGINGS_ENCHANTABILITY.get();
        }
        ...
        public float getToughness() {
            return (Integer) DZConfig.COPPER_LEGGINGS_TOUGHNESS.get();
        }

        @Override
        public float getKnockbackResistance() {
            return (Integer) DZConfig.COPPER_LEGGINGS_KNOCK_BACK_RESISTANCE.get();
        }
