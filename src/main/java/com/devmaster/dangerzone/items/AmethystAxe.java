...
public class AmethystAxe extends AxeItem {
    private static IItemTier iItemTier = new IItemTier() {
        ...
        public int getMaxUses() {
            return (Integer) DZConfig.AMETHYST_AXE_DURABILITY.get();
        }
    ...
    public AmethystAxe() {
        super(iItemTier, (Integer)DZConfig.AMETHYST_AXE_DAMAGE.get(), -2.4F, (new Properties()).group(DangerZone.TOOLS));
    }
    ...
    public boolean hitEntity(ItemStack stack, LivingEntity target, LivingEntity attacker) {
        stack.damageItem((Integer)DZConfig.AMETHYST_AXE_HIT_COST.get(), attacker, (playerEntity) -> {
