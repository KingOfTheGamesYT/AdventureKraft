...
public class CoarseAmethystLeggings extends ArmorItem {
    private static IArmorMaterial iArmorMaterial = new IArmorMaterial() {

        public int getDurability(EquipmentSlotType slotIn) {
            return (Integer) DZConfig.COARSE_AMETHYST_LEGGINGS_DURABILITY.get();
        }

        @Override
        public int getDamageReductionAmount(EquipmentSlotType slotIn) {
            return (Integer) DZConfig.COARSE_AMETHYST_LEGGINGS_ARMOR.get();
        }

        @Override
        public int getEnchantability() {
            return (Integer) DZConfig.COARSE_AMETHYST_LEGGINGS_ENCHANTABILITY.get();
        }
        ...
        public float getToughness() {
            return (Integer) DZConfig.COARSE_AMETHYST_LEGGINGS_TOUGHNESS.get();
        }

        @Override
        public float getKnockbackResistance() {
            return (Integer) DZConfig.COARSE_AMETHYST_LEGGINGS_KNOCK_BACK_RESISTANCE.get();
        }

    };

    public CoarseAmethystLeggings() {
    ...
    public boolean HitByEntity(ItemStack stack, LivingEntity target, LivingEntity attacker) {
        stack.damageItem((Integer)DZConfig.COARSE_AMETHYST_BOOTS_HIT_COST.get(), attacker, (playerEntity) -> {
    ...
    public void addInformation(ItemStack stack, World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
        tooltip.add(new StringTextComponent("\u00A75" + "Shinning" + "\u00A75"));
    }
}