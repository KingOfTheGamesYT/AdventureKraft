...
public class CoarseAmethystHelmet extends ArmorItem {
    private static IArmorMaterial iArmorMaterial = new IArmorMaterial() {

        public int getDurability(EquipmentSlotType slotIn) {
            return (Integer) DZConfig.COARSE_AMETHYST_HELMET_DURABILITY.get();
        }

        @Override
        public int getDamageReductionAmount(EquipmentSlotType slotIn) {
            return (Integer)DZConfig.COARSE_AMETHYST_HELMET_ARMOR.get();

        }

        @Override
        public int getEnchantability() {
            return (Integer)DZConfig.COARSE_AMETHYST_HELMET_ENCHANTABILITY.get();
        ...
        public float getToughness() {
            return (Integer)DZConfig.COARSE_AMETHYST_HELMET_TOUGHNESS.get();
        }

        @Override
        public float getKnockbackResistance() {
            return (Integer)DZConfig.COARSE_AMETHYST_HELMET_KNOCK_BACK_RESISTANCE.get();

        }

    };

    public CoarseAmethystHelmet() {
    ...
    public boolean HitByEntity(ItemStack stack, LivingEntity target, LivingEntity attacker) {
        stack.damageItem((Integer)DZConfig.COARSE_AMETHYST_HELMET_HIT_COST.get(), attacker, (playerEntity) -> {
