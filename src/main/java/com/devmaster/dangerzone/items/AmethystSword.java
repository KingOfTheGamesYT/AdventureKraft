...
public class AmethystSword extends SwordItem {
    private static IItemTier iItemTier = new IItemTier() {
        ...
        public int getMaxUses() {
            return (Integer) DZConfig.AMETHYST_SWORD_DURABILITY.get();
        }
    ...
    public AmethystSword() {
        super(iItemTier, (Integer)DZConfig.AMETHYST_SWORD_DAMAGE.get(), -2.4F, (new Properties()).group(DangerZone.WEAPONS));
    }
    ...
    public boolean hitEntity(ItemStack stack, LivingEntity target, LivingEntity attacker) {
        stack.damageItem((Integer)DZConfig.AMETHYST_SWORD_HIT_COST.get(), attacker, (playerEntity) -> {
