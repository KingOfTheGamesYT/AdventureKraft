...
public class AntModel<N extends AnimalEntity> extends EntityModel<RainbowAnt> {
	...
	@Override
	public void setRotationAngles(RainbowAnt entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
