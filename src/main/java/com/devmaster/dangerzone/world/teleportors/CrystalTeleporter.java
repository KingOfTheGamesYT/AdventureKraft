...
public class CrystalTeleporter implements ITeleporter {
	...
	private PortalInfo placeInWorld(ServerWorld destWorld, Entity entity, BlockPos pos, boolean isPlayer) {
		...
		boolean isFromCrystal = entity.world.getDimensionKey() == RegistryHandler.CRYSTAL && isToOverworld;
	...
	private PortalInfo moveToSafeCoords(ServerWorld world, Entity entity, BlockPos pos) {
		boolean toCrystal = world.getDimensionKey() == RegistryHandler.CRYSTAL;
