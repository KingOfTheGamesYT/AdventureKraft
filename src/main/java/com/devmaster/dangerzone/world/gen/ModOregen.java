...
public class ModOregen {
    ...
    public static void addConfigFeatures(RegistryEvent.Register<Feature<?>> event){
        ...
        MAGMA_CUBE_ORE = Feature.ORE.withConfiguration(
                        new OreFeatureConfig(OreFeatureConfig.FillerBlockType.BASE_STONE_OVERWORLD, RegistryHandler.MAGMA_CUBE_EGG_ORE.get().getDefaultState(),3))
                .withPlacement(Placement.RANGE.configure(new TopSolidRangeConfig(0, 0, 128))
                        .square()
                        .chance/* repeat */(3));
