...
public class ArmoredMobSpawnEvents {
    ...
    static {
        ...
        swordList = new Item[]{RegistryHandler.POPPY_SWORD.get(), RegistryHandler.COARSE_AMETHYST_SWORD.get(), RegistryHandler.CAKE_SWORD.get(), RegistryHandler.EMERALD_SWORD.get(), RegistryHandler.SAPPHIRE_SWORD.get(), RegistryHandler.QUEEN_GHIDORAH_SCALE_BATTLE_AXE.get(), RegistryHandler.MANTIS_CLAW.get()};
