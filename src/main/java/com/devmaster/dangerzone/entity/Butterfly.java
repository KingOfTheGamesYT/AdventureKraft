...
public class Butterfly extends CreatureEntity {
    ...
    public static final Map<Integer, ResourceLocation> TEXTURE = Util.make(Maps.newHashMap(), (p_213410_0_) -> {
        p_213410_0_.put(0, new ResourceLocation(DangerZone.MOD_ID, "textures/entity/butterfly.png"));
        p_213410_0_.put(1, new ResourceLocation(DangerZone.MOD_ID, "textures/entity/butterfly2.png"));
        p_213410_0_.put(2, new ResourceLocation(DangerZone.MOD_ID, "textures/entity/butterfly3.png"));
        p_213410_0_.put(4, new ResourceLocation(DangerZone.MOD_ID, "textures/entity/butterfly4.png"));
    });
