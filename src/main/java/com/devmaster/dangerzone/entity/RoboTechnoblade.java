...
public class RoboTechnoblade extends CreatureEntity {

    public RoboTechnoblade(final EntityType<? extends RoboTechnoblade> type, final World worldIn) {
        super(type, worldIn);
    ...
    protected void registerGoals() {
        ...
        this.targetSelector.addGoal(3, new NearestAttackableTargetGoal<>(this, Allosaurus.class, true));
